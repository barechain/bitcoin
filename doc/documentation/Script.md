...
Scripts are encapsulated using the \Barechain\Bitcoin\Script\Script class.

Script types supported by the library can be classified. 

### \Barechain\Bitcoin\Script\Classifier\OutputScriptClassifier
...
The `Barechain\Bitcoin\Script\Parser\Parser` class is used to parse & decode scripts. 
...
`Barechain\Bitcoin\Script\Interpreter\Interpreter` is the native implementation of the script language. 
