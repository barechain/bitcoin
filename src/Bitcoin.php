...
namespace Barechain\Bitcoin;

use Barechain\Bitcoin\Chain\Params;
use Barechain\Bitcoin\Chain\ParamsInterface;
use Barechain\Bitcoin\Crypto\EcAdapter\Adapter\EcAdapterInterface;
use Barechain\Bitcoin\Crypto\EcAdapter\EcAdapterFactory;
