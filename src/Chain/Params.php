...
namespace Barechain\Bitcoin\Chain;

use Barechain\Bitcoin\Block\Block;
use Barechain\Bitcoin\Block\BlockHeader;
use Barechain\Bitcoin\Block\BlockHeaderInterface;
