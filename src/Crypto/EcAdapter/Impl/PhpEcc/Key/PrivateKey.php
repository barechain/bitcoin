...
namespace Barechain\Bitcoin\Crypto\EcAdapter\Impl\PhpEcc\Key;

use Barechain\Bitcoin\Bitcoin;
use Barechain\Bitcoin\Crypto\EcAdapter\Impl\PhpEcc\Adapter\EcAdapter;
use Barechain\Bitcoin\Crypto\EcAdapter\Impl\PhpEcc\Serializer\Key\PrivateKeySerializer;
use Barechain\Bitcoin\Crypto\EcAdapter\Impl\PhpEcc\Signature\CompactSignature;
use Barechain\Bitcoin\Crypto\EcAdapter\Signature\CompactSignatureInterface;
use Barechain\Bitcoin\Crypto\EcAdapter\Impl\PhpEcc\Signature\Signature;
use Barechain\Bitcoin\Crypto\EcAdapter\Key\Key;
...
use Barechain\Bitcoin\Crypto\Random\RbgInterface;
use Barechain\Bitcoin\Crypto\Random\Rfc6979;
use Barechain\Bitcoin\Exceptions\InvalidPrivateKey;
