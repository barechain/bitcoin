...
namespace Barechain\Bitcoin\Crypto\EcAdapter\Impl\Secp256k1\Key;

use Barechain\Bitcoin\Bitcoin;
use Barechain\Bitcoin\Crypto\EcAdapter\Impl\Secp256k1\Adapter\EcAdapter;
use Barechain\Bitcoin\Crypto\EcAdapter\Impl\Secp256k1\Serializer\Key\PrivateKeySerializer;
use Barechain\Bitcoin\Crypto\EcAdapter\Impl\Secp256k1\Signature\CompactSignature;
use Barechain\Bitcoin\Crypto\EcAdapter\Impl\Secp256k1\Signature\Signature;
