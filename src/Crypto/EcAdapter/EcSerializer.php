...
namespace Barechain\Bitcoin\Crypto\EcAdapter;
...
class EcSerializer
{
    const PATH_PHPECC = 'Barechain\Bitcoin\Crypto\EcAdapter\Impl\PhpEcc\\';
    const PATH_SECP256K1 = 'Barechain\Bitcoin\Crypto\EcAdapter\Impl\Secp256k1\\';
    ...
    {
        return [
            'Barechain\Bitcoin\Crypto\EcAdapter\Impl\PhpEcc\Adapter\EcAdapter' => 'Barechain\Bitcoin\Crypto\EcAdapter\Impl\PhpEcc\\',
            'Barechain\Bitcoin\Crypto\EcAdapter\Impl\Secp256k1\Adapter\EcAdapter' => 'Barechain\Bitcoin\Crypto\EcAdapter\Impl\Secp256k1\\'
        ];
    }
