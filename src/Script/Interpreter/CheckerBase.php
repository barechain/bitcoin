...
use Barechain\Bitcoin\Crypto\EcAdapter\Impl\PhpEcc\Key\PublicKey;
...
use Barechain\Bitcoin\Exceptions\SignatureNotCanonical;
...
use Barechain\Bitcoin\Transaction\TransactionInputInterface;
...
abstract class CheckerBase
{
    ...
    /**
     * @param \Barechain\Bitcoin\Script\Interpreter\Number $scriptLockTime
     * @return bool
     */
    public function checkLockTime(\Barechain\Bitcoin\Script\Interpreter\Number $scriptLockTime): bool
    {
    ...
    /**
     * @param \Barechain\Bitcoin\Script\Interpreter\Number $sequence
     * @return bool
     */
    public function checkSequence(\Barechain\Bitcoin\Script\Interpreter\Number $sequence): bool
    {
