...
namespace Barechain\Bitcoin\Script\Factory;
...
class ScriptCreator
{
    ...
    public function push(BufferInterface $data)
    {
        ...
        if ($length < Opcodes::OP_PUSHDATA1) {
            ...
            $opCode = constant("Barechain\\Bitcoin\\Script\\Opcodes::OP_PUSHDATA" . $lengthSize);
    ...
    public function int(int $n)
    {
        if ($n === 0) {
            ...
            $this->script .= chr(\Barechain\Bitcoin\Script\encodeOpN($n));
        } else {
