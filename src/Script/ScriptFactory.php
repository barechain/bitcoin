...
use Barechain\Bitcoin\Script\Consensus\BitcoinConsensus;
use Barechain\Bitcoin\Script\Consensus\ConsensusInterface;
use Barechain\Bitcoin\Script\Consensus\NativeConsensus;
use Barechain\Bitcoin\Script\Factory\OutputScriptFactory;
use Barechain\Bitcoin\Script\Factory\ScriptCreator;
...
class ScriptFactory
{
    ...
    public static function pushAll(array $buffers): ScriptInterface
    {
        return self::sequence(array_map(function ($buffer) {
            ...
            if ($size === 1 && $first >= 1 && $first <= 16) {
                return \Barechain\Bitcoin\Script\encodeOpN($first);
            } else {
                return $buffer;
            }
        }, $buffers));
    ...
    /**
     * @param int[]|\Barechain\Bitcoin\Script\Interpreter\Number[]|BufferInterface[] $sequence
     * @return ScriptInterface
     */
