...
use Barechain\Bitcoin\Exceptions\ScriptRuntimeException;
use Barechain\Bitcoin\Exceptions\SignerException;
use Barechain\Bitcoin\Exceptions\UnsupportedScript;
use Barechain\Bitcoin\Locktime;
use Barechain\Bitcoin\Script\Classifier\OutputData;
use Barechain\Bitcoin\Script\FullyQualifiedScript;
...
use Barechain\Bitcoin\Script\Interpreter\Number;
use Barechain\Bitcoin\Script\Interpreter\Stack;
use Barechain\Bitcoin\Script\Opcodes;
use Barechain\Bitcoin\Script\Parser\Operation;
use Barechain\Bitcoin\Script\Path\BranchInterpreter;
use Barechain\Bitcoin\Script\ScriptFactory;
use Barechain\Bitcoin\Script\ScriptInfo\Multisig;
use Barechain\Bitcoin\Script\ScriptInfo\PayToPubkey;
use Barechain\Bitcoin\Script\ScriptInfo\PayToPubkeyHash;
use Barechain\Bitcoin\Script\ScriptInterface;
use Barechain\Bitcoin\Script\ScriptType;
use Barechain\Bitcoin\Script\ScriptWitness;
...
class InputSigner implements InputSignerInterface
{
     ...
     * @throws \Barechain\Bitcoin\Exceptions\ScriptRuntimeException
     */
