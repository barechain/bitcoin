...
namespace Barechain\Bitcoin\Key\Deterministic\Slip132;

use Barechain\Bitcoin\Bitcoin;
use Barechain\Bitcoin\Key\Deterministic\HdPrefix\ScriptPrefix;
...
class Slip132
{
     ...
     * @return ScriptPrefix
     * @throws \Barechain\Bitcoin\Exceptions\InvalidNetworkParameter
     */
