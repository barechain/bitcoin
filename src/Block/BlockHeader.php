...
use Barechain\Bitcoin\Exceptions\InvalidHashLengthException;
...
class BlockHeader extends Serializable implements BlockHeaderInterface
{
     ...
     *
     * {@inheritdoc}
     * @see \Barechain\Bitcoin\Block\BlockHeaderInterface::getVersion()
     */
    ...
    /**
     * {@inheritdoc}
     * @see \Barechain\Bitcoin\Block\BlockHeaderInterface::getPrevBlock()
     */
    ...
    /**
     * {@inheritdoc}
     * @see \Barechain\Bitcoin\Block\BlockHeaderInterface::getMerkleRoot()
     */
    ...
    /**
     * {@inheritdoc}
     * @see \Barechain\Bitcoin\Block\BlockHeaderInterface::getBits()
     */
    ...
    /**
     * {@inheritdoc}
     * @see \Barechain\Bitcoin\Block\BlockHeaderInterface::getNonce()
     */
     ...
     *
     * {@inheritdoc}
     * @see \Barechain\Bitcoin\Block\BlockHeaderInterface::getTimestamp()
     */
